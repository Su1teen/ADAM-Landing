  ...
  const videoItems: VideoItem[] = [
    {
      ...
      features: ['Мониторинг здоровья и сна', 'Автоматическая безопасность', 'Умная экономия энергии']
    },
    {
      id: 2,
      ...
      description: 'От освещения до робота-пылесоса — АДАМ объединяет все устройства дома в единую экосистему. Один голос управляет всем.',
    ...
    },
    {
      ...
      features: ['Изучение рутины и привычек', 'Персонализация настроек', 'Автоматическая адаптация']
    },
    {
      id: 4,
